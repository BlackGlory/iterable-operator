...
): (iterable: Iterable<T | PromiseLike<T>> | AsyncIterable<T>) => AsyncIterable<Array<T | T1>>
...
): (iterable: Iterable<T | PromiseLike<T>> | AsyncIterable<T>) => AsyncIterable<Array<T | T1 | T2>>
export function zipAsync<T, T1, T2, T3>(
  iterable1: Iterable<T1 | PromiseLike<T1>> | AsyncIterable<T1>
, iterable2: Iterable<T2 | PromiseLike<T2>> | AsyncIterable<T2>
, iterable3: Iterable<T3 | PromiseLike<T3>> | AsyncIterable<T3>
): (iterable: Iterable<T | PromiseLike<T>> | AsyncIterable<T>) => AsyncIterable<Array<T | T1 | T2 | T3>>
export function zipAsync<T, T1, T2, T3, T4>(
  iterable1: Iterable<T1 | PromiseLike<T1>> | AsyncIterable<T1>
, iterable2: Iterable<T2 | PromiseLike<T2>> | AsyncIterable<T2>
, iterable3: Iterable<T3 | PromiseLike<T3>> | AsyncIterable<T3>
, iterable4: Iterable<T4 | PromiseLike<T4>> | AsyncIterable<T4>
): (iterable: Iterable<T | PromiseLike<T>> | AsyncIterable<T>) => AsyncIterable<Array<T | T1 | T2 | T3 | T4>>
...
): (iterable: Iterable<T | PromiseLike<T>> | AsyncIterable<T>) => AsyncIterable<Array<T | T1 | T2 | T3 | T4 | T5>>
...
): (iterable: Iterable<T | PromiseLike<T>> | AsyncIterable<T>) => AsyncIterable<Array<T | T1 | T2 | T3 | T4 | T5 | T6>>
...
): (iterable: Iterable<T | PromiseLike<T>> | AsyncIterable<T>) => AsyncIterable<Array<T | T1 | T2 | T3 | T4 | T5 | T6 | T7>>
