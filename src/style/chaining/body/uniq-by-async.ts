...
export class UniqByAsyncOperator<T, U extends Iterable<T> | AsyncIterable<T>> extends Subject<U> {
  uniqByAsync<U>(fn: (element: T, index: number) => U | PromiseLike<U>): AsyncIterableOperator<T>
