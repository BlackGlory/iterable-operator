...
describe('IterableOperator<T>::reduceAsync(fn: (accumulator: T, currentValue: T, index: number) => T | PromiseLike<T>) => Promise<T>', () => {
...
describe('reduceAsync<T, U>(fn: (accumulator: U, currentValue: T, index: number) => U | PromiseLike<U>, initalValue: U): Promise<U>', () => {
