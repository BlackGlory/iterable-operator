...
import { FlattenAsyncOperator } from '@style/chaining/body/flatten-async'
...
describe('flattenAsync', () => {
  ...
  , testAsyncIterableChain('AsyncIterableOperator::flattenAsync() -> AsyncIterableOperator<T>', FlattenAsyncOperator.prototype.flattenAsync)
  ])('%s', (_, flattenAsync) => {
