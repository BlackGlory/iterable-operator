...
import { ToArrayAsyncOperator } from '@style/chaining/tail/to-array-async'
...
describe('toArrayAsync', () => {
  ...
  , testAsyncMethod('AsyncIterableOperator::toArrayAsync() -> Promise<T[]>', ToArrayAsyncOperator.prototype.toArrayAsync)
  ])('%s', (_, toArrayAsync) => {
    describe('call', () => {
