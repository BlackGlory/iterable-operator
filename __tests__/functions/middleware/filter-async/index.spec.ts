...
, testPipe('filterAsync<T, U extends T = T>(fn: (element: T, index: number) => boolean | PromiseLike<boolean>): (iterable: Iterable<T> | AsyncIterable<T>) => AsyncIterable<U>', pipe)
, testBind('filterAsync<T, U extends T = T>(this: Iterable<T> | AsyncIterable<T>, fn: (element: T, index: number) => boolean | PromiseLike<boolean>): AsyncIterable<U>', bind)
])('%s', (_, filterAsync) => {
  describe('filterAsync(iterable: Iterable<PromiseLike<T>>, fn: (element: PromiseLike<T>, index: number) => boolean | PromiseLike<boolean>): AsyncIterable<U>', () => {
  ...
  describe.each([
    testIterable('filterAsync<T, U extends T = T>(iterable: Iterable<T>, fn: (element: T, index: number) => boolean | PromiseLike<boolean>): AsyncIterable<U>')
  , testAsyncIterable('filterAsync<T, U extends T = T>(iterable: AsyncIterable<T>, fn: (element: T, index: number) => boolean | PromiseLike<boolean>): AsyncIterable<U>')
  ])('%s', (_, getIter) => {
