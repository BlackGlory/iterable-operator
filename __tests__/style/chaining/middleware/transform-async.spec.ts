...
describe('IterableOperator<T, U extends Iterable<T>>::transformAsync<T>(transformer: (iterable: Iterable<U>) => AsyncIterable<T>): AsyncIterableOperator<T>', () => {
...
describe('AsyncIterableOperator<T, U extends Iterable<T>>::transformAsync<T>(transformer: (iterable: AsyncIterable<U>) => AsyncIterable<T>): AsyncIterableOperator<T>', () => {
  it('is chaining style', () => {
    const spy = jest.spyOn(middleware, 'transformAsync')
